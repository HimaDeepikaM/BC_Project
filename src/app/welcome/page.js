...
<div className='bg-gradient-to-r from-gray-500 via-gray-400 to-blue-300 rounded-lg shadow-xl p-10 max-w-lg w-full'>
            ...
            <h2 className="text-4xl font-bold text-center mb-4 text-black">Find Your Chill on Frosty Finds!</h2>
            ...
            <div className="grid grid-rows-3 gap-4 grid-flow-row-dense">
                ...
                {defaultAccount && <p className="text-blue-800 mt-4 text-center">Connected as {defaultAccount}</p>}
